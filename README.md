...
| FACILITY_NAME                                       | Optional. Full name of the facility (default: "New AGLAE"). Used in templates, emails, and admin messages for branding                                                                                                                            |
| FACILITY_SHORT_NAME                                 | Optional. Short name of the facility (default: "AGLAE"). Used in templates and UI elements for branding                                                                                                                                           |
| FACILITY_URL                                        | Optional. URL to the facility's website (default: "https://c2rmf.fr/aglae-0"). Used in emails and other communications                                                                                                                            |
