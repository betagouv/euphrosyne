...
| RADIATION_PROTECTION_ADDITIONAL_NOTIFICATION_EMAILS | Additional emails to notify when a user successfully passes the radiation protection certification and to receive employer information reminder summaries                                                                                         |
| PARTICIPATION_EMPLOYER_FORM_EXEMPT_ROR_IDS          | Comma-separated list of ROR IDs for institutions exempt from the employer form requirement and the radiation protection electrical signature process                                                                                              |
