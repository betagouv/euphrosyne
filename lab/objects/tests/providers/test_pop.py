...
@mock.patch(
    "lab.objects.providers.pop.POPProvider._fetch_raw_data",
    return_value=FETCH_RAW_DATA_RETURN,
)
def test_fetch_full_objectgroup_from_pop(_):
    ...
    assert og.inventory == "83356"
    assert og.materials == ["bois de renne", "incision", "polissage"]


@mock.patch(
    "lab.objects.providers.pop.POPProvider._fetch_iif_manifest",
