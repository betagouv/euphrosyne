...
def normalize_employer_names(apps, schema_editor):
    Employer = apps.get_model("lab", "Employer")
    for employer_id, first_name, last_name in Employer.objects.all().values_list(
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(normalize_employer_names, migrations.RunPython.noop),
    ]
