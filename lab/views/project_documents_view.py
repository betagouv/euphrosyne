...
from ..object_storage import list_project_documents, upload_project_document
...
class ProjectDocumentsView(LoginRequiredMixin, FormView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            for file in files:
                upload_project_document(file, self.project.id)
